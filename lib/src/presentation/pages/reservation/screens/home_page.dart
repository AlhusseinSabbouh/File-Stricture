...
import 'package:line_up/src/presentation/pages/reservation/widget/fill_remaining_sliver.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        floatingActionButton: const FloatingActionButtomWidget(),
...
List<Widget> getPageWidget = const [
  ...
  FillRemainingSliverWidget(PageType.homePage)
];

class FloatingActionButtomWidget extends StatelessWidget {
  const FloatingActionButtomWidget({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton(
      onPressed: () {
        Navigator.of(context).pushNamed(Routes.searchFilter);
      },
...
//                           showPopup(
//                               context, DialogType.data, "Cancel Reservation",
//                               data: [
//                                 Padding(
...
//                         child: Container(
//                           child: Center(
//                               child: BodySmallText("Cancel Reservation")),
